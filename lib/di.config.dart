...
import 'data/data_sources/authentication_data_sources/authentication_remote_data_source.dart'
    as _i976;
...
import 'data/data_sources/products_data_sources/products_remote_data_source.dart'
    as _i275;
import 'data/data_sources_imp/authentication_data_sources/authentication_remote_data_source_imp.dart'
    as _i934;
...
import 'data/data_sources_imp/products_data_sources/products_remote_data_source_imp.dart'
    as _i481;
import 'data/repositories_imp/authentication/authentication_repository_imp.dart'
    as _i770;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i976.AuthenticationRemoteDataSource>(() =>
        _i934.AuthenticationRemoteDataSourceImp(
            apiManager: gh<_i265.ApiManager>()));
    ...
    gh.factory<_i996.AuthenticationRepository>(() =>
        _i770.AuthenticationRepositoryImp(
            authenticationRemoteDataSource:
                gh<_i976.AuthenticationRemoteDataSource>()));
    ...
    gh.factory<_i1053.SignInViewModel>(
        () => _i1053.SignInViewModel(signInUseCase: gh<_i452.SignInUseCase>()));
